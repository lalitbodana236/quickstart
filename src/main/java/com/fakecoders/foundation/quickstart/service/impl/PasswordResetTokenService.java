...
import com.fakecoders.foundation.quickstart.repository.IPasswordResetTokenRepository;
...
public class PasswordResetTokenService {
    ...
    @Autowired
    public PasswordResetTokenService(IPasswordResetTokenRepository repository) {
