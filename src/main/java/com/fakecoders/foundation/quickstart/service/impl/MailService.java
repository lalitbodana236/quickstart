...
import com.fakecoders.foundation.quickstart.model.Mail;
...
public class MailService {
    ...
    public void sendEmailVerification(String emailVerificationUrl, String to)
        ...
        Mail mail = new Mail();
        mail.setSubject("Email Verification [Team Gurkul]");
        mail.setTo(to);
    ...
    public void sendResetLink(String resetPasswordLink, String to)
        ...
        Mail mail = new Mail();
        mail.setSubject("Password Reset Link [Team Gurkul]");
        mail.setTo(to);
        mail.setFrom(mailFrom);
        mail.getModel().put("userName", to);
    ...
    public void sendAccountChangeEmail(String action, String actionStatus, String to)
            throws IOException, TemplateException, MessagingException {
        Mail mail = new Mail();
        mail.setSubject("Account Status Change [Team Gurkul]");
        mail.setTo(to);
        mail.setFrom(mailFrom);
        mail.getModel().put("userName", to);
