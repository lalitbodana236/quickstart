...
import com.fakecoders.foundation.quickstart.cache.LoggedOutJwtTokenCache;
...
public class JwtTokenValidator {
    ...
    @Autowired
    public JwtTokenValidator(@Value("${application.security.jwt.secret-key}") String jwtSecret, LoggedOutJwtTokenCache loggedOutTokenCache) {
