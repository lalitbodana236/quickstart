                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="tw-card-header"
                                                                ...
                                                                align="center"><span style="font-weight: 600;">Welcome to Gurukul</span></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <p><br/><br/></p>
                                                        ...
                                                        <tr>
                                                            <td class="tw-card-body"
                                                                ...
                                                                <p class=""
                                                                    ...
                                                                    <span style="font-weight: 400;">Thank you for joining <strong>Gurukul</strong>, your platform for knowledge and collaboration.</span><br/><br/><span
                                                                        style="font-weight: 400;">To get started, please explore your workspace, connect with teachers and students, and engage in the learning journey.</span>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="button__td "
                                                                                                    ...
                                                                                                    <![endif]--> <!-- [if !mso]><!--> <a
                                                                                                        ...
                                                                                                        target="_blank"
                                                                                                        rel="noopener">Start Exploring</a> <!--![endif]--></td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </td>
                                                                    ...
                                                                    <p class=""
                                                                        style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                                        If you have any questions or need assistance, feel free to reach out to our support team.&nbsp;<a
                                                                            style="color: #316fea; text-decoration: none;"
                                                                            href="javascript:void(0);" target="_blank" rel="noopener">Contact Support</a></p>
                                                                    <p class="tw-signoff"
                                                                        style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                                        Best regards, <br/> The Gurukul Team</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
