                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Please click the below button to change your password for <strong>Gurukul</strong>. The link will be valid for the next ${expirationTime} minutes.</span><br/><br/><span
                                            ...
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 
