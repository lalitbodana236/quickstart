                            ...
                            <tr>
                              <td class="tw-card-body" style="padding: 20px 35px; text-align: left; color: #6f6f6f; font-family: sans-serif; border-top: 0;">
                                ...
                                <p class="" style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                  <span style="font-weight: 400;">Please click the below button to change your password for <strong>Gurukul</strong>. The link will be valid for the next ${expirationTime} minutes. </span>
                                  <br />
                                  <br />
                                  <span style="font-weight: 400;">
                                    ...
                                    <p class="" style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;"> Contact our support team if you have any questions or concerns.&nbsp; <a style="color: #316fea; text-decoration: none;" href="javascript:void(0);" target="_blank" rel="noopener">Ask us any question</a>
                                    </p>
                                    <p class="tw-signoff" style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;"> Our best, <br /> The Gurukul Team </p>
                              </td>
                            </tr>
                          </tbody>
                        </table>
